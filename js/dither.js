(function () {
  ...
  void main() {
    ...
    vec3 color = waveAt(uvPixel * resolution);
  ...
  function createDither(canvas, options) {
    ...
    ['resolution', 'time', 'waveSpeed', 'waveFrequency', 'waveAmplitude', 'waveColor',
     'mousePos', 'enableMouseInteraction', 'mouseRadius', 'colorNum', 'pixelSize']
    ...
    gl.uniform3f(u.waveColor, opts.waveColor[0], opts.waveColor[1], opts.waveColor[2]);
    gl.uniform1f(u.colorNum, opts.colorNum);
    gl.uniform1f(u.pixelSize, opts.pixelSize);
    gl.uniform1f(u.mouseRadius, opts.mouseRadius);
    gl.uniform1i(u.enableMouseInteraction, opts.enableMouseInteraction ? 1 : 0);
    ...
    function onPointerMove(e) {
      const rect = canvas.getBoundingClientRect();
      gl.uniform2f(u.mousePos, e.clientX - rect.left, e.clientY - rect.top);
    }
  ...
  const instance = createDither(canvas, {
    waveColor: [0.73, 0.73, 0.73],
    waveSpeed: 0.035,
    waveFrequency: 2.6,
    waveAmplitude: 0.32,
    colorNum: 4,
    ...
    enableMouseInteraction: !isCoarse && !prefersReduced
  });
  ...
  document.documentElement.classList.add('has-dither');
